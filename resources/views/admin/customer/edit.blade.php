                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.customer.update', $customer->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="mobile" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile', $customer->mobile) }}" required autocomplete="email">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route('admin.customer.index')}}" class="btn btn-dark">
                                    {{ __('Back') }}
                                </a>
                            </div>
                        </div>
